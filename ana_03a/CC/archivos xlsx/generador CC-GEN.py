...
def gen_CC_GEN():
    ...
    carpeta = r"G:\Mi unidad\Proyectos Análisis de Datos\1_Visualizaición de información contable - Cadena rasa\ana_03a\CC"
    ...
    print('Archivo CC-GEN.csv generado en carpeta de cobros a clientes.')
