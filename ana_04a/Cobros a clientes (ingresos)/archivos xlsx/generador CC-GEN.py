...
def df_de_xlsx(etiqueta):
    ...
    df = pds.read_excel((os.path.join(os.path.dirname(__file__),f'CC-{etiqueta}.xlsx')))
...
def gen_CC_GEN():
    ...
    carpeta = r"G:\Mi unidad\Proyectos Análisis de Datos\1_Visualizaición de información contable-02a\ana_04a\Cobros a clientes (ingresos)"
    ...
    print('Archivo CC-GEN.xlsx generado en carpeta de cobros a clientes.')
